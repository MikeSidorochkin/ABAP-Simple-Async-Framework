[![Build Status](https://travis-ci.com/MikeSidorochkin/ABAP-Simple-pRFC-Framework.svg?branch=main)](https://travis-ci.com/MikeSidorochkin/ABAP-Simple-pRFC-Framework)
